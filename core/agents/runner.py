...
AGENT_CAPABILITIES: dict[str, list[str]] = {
    ...
    "debugger": ["debug", "trace", "stack", "root cause", "fix bug", "log analysis",
                 "breakpoint", "crash", "reproduce", "bisect"],
    "graphic_designer": ["graphic", "logo", "banner", "brand identity", "flyer",
                         "brochure", "infographic", "mockup", "presentation"],
    "executive_planner": ["strategy", "executive", "roadmap", "portfolio", "initiative",
                          "go-to-market", "architecture decision", "budget"],
    "project_manager": ["project", "sprint", "agile", "backlog", "milestone",
                        "deliverable", "stakeholder", "retrospective"],
    "research_analyst": ["research", "market analysis", "competitive", "benchmark",
                         "literature review", "vendor evaluation", "trend"],
    "data_analyst": ["data", "statistics", "hypothesis", "forecast", "dashboard",
                     "cohort", "segmentation", "ab test", "kpi"],
    "content_writer": ["content", "blog", "article", "newsletter", "copy",
                       "social post", "script", "case study", "press release"],
    ...
    "voice_assistant": ["voice", "speech", "tts", "stt", "audio", "narration", "conversation",
                        "vui", "dialog"],
    "sales_agent": ["sales", "pipeline", "closing", "prospecting", "negotiation", "crm",
                    "quota", "forecasting"],
    "customer_support_agent": ["support", "ticket", "helpdesk", "customer", "faq",
                               "troubleshooting", "escalation", "refund"],
    "email_manager": ["email", "inbox", "triage", "categorize", "draft", "reply",
                      "newsletter", "follow-up"],
    "accountant": ["accounting", "bookkeeping", "invoice", "expense", "tax",
                   "ledger", "reconciliation", "cashflow"],
    "personal_assistant": ["assistant", "calendar", "schedule", "meeting", "travel",
                           "reminder", "agenda", "itinerary"],
    "social_media_manager": ["social", "post", "tweet", "instagram", "linkedin",
                             "facebook", "tiktok", "engagement", "content calendar"],
    "proposal_writer": ["proposal", "rfp", "rfq", "bid", "sow", "quote",
                        "scope", "pricing"],
    "security_monitor": ["monitor", "ids", "ips", "log", "alert", "incident",
                         "threat", "vulnerability scan"],
}

AGENT_METADATA: dict[str, dict] = {
    "ceo": {"name": "CEO AI", "category": "orchestrator",
            "description": "Orchestrates multi-agent workflows across all specialists",
            "icon": "Crown", "capabilities": AGENT_CAPABILITIES["ceo"],
            "team": "leadership"},
    "planner": {"name": "Planner", "category": "specialist",
                "description": "Strategic planning, task decomposition, milestones",
                "icon": "ClipboardList", "capabilities": AGENT_CAPABILITIES["planner"],
                "team": "development"},
    "programmer": {"name": "Programmer", "category": "specialist",
                   "description": "Full-stack software development and coding",
                   "icon": "Code", "capabilities": AGENT_CAPABILITIES["programmer"],
                   "team": "development"},
    "tester": {"name": "Tester", "category": "specialist",
               "description": "Quality assurance, testing, and bug detection",
               "icon": "Bug", "capabilities": AGENT_CAPABILITIES["tester"],
               "team": "quality"},
    "debugger": {"name": "Debugger", "category": "specialist",
                 "description": "Intelligent debugging — read source, reproduce, trace, fix, verify",
                 "icon": "Bug", "capabilities": AGENT_CAPABILITIES["debugger"],
                 "team": "quality"},
    "graphic_designer": {"name": "Graphic Designer", "category": "specialist",
                         "description": "Visual design — logos, banners, brand assets, social posts",
                         "icon": "Image", "capabilities": AGENT_CAPABILITIES["graphic_designer"],
                         "team": "design"},
    "executive_planner": {"name": "Executive Planner", "category": "specialist",
                          "description": "Senior strategic planning, roadmaps, portfolio management",
                          "icon": "Target", "capabilities": AGENT_CAPABILITIES["executive_planner"],
                          "team": "leadership"},
    "project_manager": {"name": "Project Manager", "category": "specialist",
                        "description": "Project coordination, sprints, milestones, stakeholder updates",
                        "icon": "Kanban", "capabilities": AGENT_CAPABILITIES["project_manager"],
                        "team": "leadership"},
    "research_analyst": {"name": "Research Analyst", "category": "specialist",
                         "description": "Deep research, market analysis, competitive intelligence",
                         "icon": "Search", "capabilities": AGENT_CAPABILITIES["research_analyst"],
                         "team": "business"},
    "data_analyst": {"name": "Data Analyst", "category": "specialist",
                     "description": "Data analysis, statistics, dashboards, forecasting",
                     "icon": "PieChart", "capabilities": AGENT_CAPABILITIES["data_analyst"],
                     "team": "business"},
    "content_writer": {"name": "Content Writer", "category": "specialist",
                       "description": "Professional content — blogs, social, scripts, newsletters, copy",
                       "icon": "PenLine", "capabilities": AGENT_CAPABILITIES["content_writer"],
                       "team": "content"},
    "designer": {"name": "Designer", "category": "specialist",
                 "description": "UI/UX design, design systems, visual branding",
                 "icon": "Palette", "capabilities": AGENT_CAPABILITIES["designer"],
                 "team": "design"},
    "browser_operator": {"name": "Browser Operator", "category": "specialist",
                         "description": "Web automation, scraping, form filling",
                         "icon": "Globe", "capabilities": AGENT_CAPABILITIES["browser_operator"],
                         "team": "automation"},
    "devops_engineer": {"name": "DevOps Engineer", "category": "specialist",
                        "description": "CI/CD, Docker, K8s, cloud infrastructure",
                        "icon": "Container", "capabilities": AGENT_CAPABILITIES["devops_engineer"],
                        "team": "infrastructure"},
    "security_auditor": {"name": "Security Auditor", "category": "specialist",
                         "description": "Vulnerability assessment, compliance, OWASP",
                         "icon": "Shield", "capabilities": AGENT_CAPABILITIES["security_auditor"],
                         "team": "security"},
    "database_engineer": {"name": "Database Engineer", "category": "specialist",
                          "description": "Schema design, queries, migrations, optimization",
                          "icon": "Database", "capabilities": AGENT_CAPABILITIES["database_engineer"],
                          "team": "infrastructure"},
    "mobile_developer": {"name": "Mobile Developer", "category": "specialist",
                         "description": "Flutter, React Native, native mobile apps",
                         "icon": "Smartphone", "capabilities": AGENT_CAPABILITIES["mobile_developer"],
                         "team": "development"},
    "marketing_agent": {"name": "Marketing Agent", "category": "specialist",
                        "description": "Campaigns, SEO, content, growth strategy",
                        "icon": "Megaphone", "capabilities": AGENT_CAPABILITIES["marketing_agent"],
                        "team": "business"},
    "finance_agent": {"name": "Finance Agent", "category": "specialist",
                      "description": "Budgeting, forecasting, financial analysis",
                      "icon": "BarChart3", "capabilities": AGENT_CAPABILITIES["finance_agent"],
                      "team": "business"},
    "documentation_writer": {"name": "Documentation Writer", "category": "specialist",
                             "description": "API docs, guides, ADRs, READMEs",
                             "icon": "FileText", "capabilities": AGENT_CAPABILITIES["documentation_writer"],
                             "team": "content"},
    "voice_assistant": {"name": "Voice Assistant", "category": "specialist",
                        "description": "TTS/STT, voice UI, conversation design",
                        "icon": "Headphones", "capabilities": AGENT_CAPABILITIES["voice_assistant"],
                        "team": "content"},
    "sales_agent": {"name": "Sales Agent", "category": "specialist",
                    "description": "Sales strategy, pipeline management, proposals, closing",
                    "icon": "TrendingUp", "capabilities": AGENT_CAPABILITIES["sales_agent"],
                    "team": "business"},
    "customer_support_agent": {"name": "Customer Support", "category": "specialist",
                               "description": "Ticket triage, helpdesk, troubleshooting, FAQs",
                               "icon": "HelpCircle", "capabilities": AGENT_CAPABILITIES["customer_support_agent"],
                               "team": "support"},
    "email_manager": {"name": "Email Manager", "category": "specialist",
                      "description": "Inbox triage, smart categorization, draft replies",
                      "icon": "AtSign", "capabilities": AGENT_CAPABILITIES["email_manager"],
                      "team": "communication"},
    "accountant": {"name": "Accountant", "category": "specialist",
                   "description": "Bookkeeping, invoices, tax prep, cash flow",
                   "icon": "Calculator", "capabilities": AGENT_CAPABILITIES["accountant"],
                   "team": "business"},
    "personal_assistant": {"name": "Personal Assistant", "category": "specialist",
                           "description": "Calendar, scheduling, meetings, travel planning",
                           "icon": "Calendar", "capabilities": AGENT_CAPABILITIES["personal_assistant"],
                           "team": "support"},
    "social_media_manager": {"name": "Social Media Manager", "category": "specialist",
                             "description": "Content calendars, posting, engagement, analytics",
                             "icon": "Share2", "capabilities": AGENT_CAPABILITIES["social_media_manager"],
                             "team": "marketing"},
    "proposal_writer": {"name": "Proposal Writer", "category": "specialist",
                        "description": "RFPs, business proposals, SOWs, branded PDFs",
                        "icon": "PenLine", "capabilities": AGENT_CAPABILITIES["proposal_writer"],
                        "team": "business"},
    "security_monitor": {"name": "Security Monitor", "category": "specialist",
                         "description": "Real-time security monitoring, alerts, incident response",
                         "icon": "Eye", "capabilities": AGENT_CAPABILITIES["security_monitor"],
                         "team": "security"},
}
...
class AgentRun:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "agent_name": self.agent_name, "task": self.task,
...
class AgentRunner:
    ...
    async def run(self, agent_id: str, task: str, context: dict | None = None,
                  model: str = "") -> AgentRun:
        agent = self.get_agent(agent_id)
        run = AgentRun(
            run_id=uuid.uuid4().hex[:12],
            agent_id=agent_id, task=task, context=context or {},
        )
        run.status = "running"
        run.model = model
